...
$(document).ready(function () {
  ...
  chiamata_get_init(); //intercetto il cambio di valore della select con la funzione change

  $('.select').change(function () {
    //resetto l'html
    $('.card_container').html(''); // recupero il valore selezionato
  ...
  function chiamata_get_init() {
    ...
    $.ajax({
      ...
      'success': function success(data) {
        ...
        var todos = JSON.parse(data); //ciclo l'array e stampo tutto a schermo
  ...
  function stampa_select(array) {
    ...
    var template_select = Handlebars.compile(source_2); //creo array vuoto che conterrà gli artisti senza doppioni

    var artisti = []; //ciclo per controllare se nell'array è già presente l'artista
    ...
    for (var i = 0; i < artisti.length; i++) {
      ...
      var html_select = template_select(context_2); //appendo tutto alla select
...
__webpack_require__(/*! C:\MAMP\htdocs\playground\php-dischi\src\js\app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! C:\MAMP\htdocs\playground\php-dischi\src\scss\app.scss */"./src/scss/app.scss");
